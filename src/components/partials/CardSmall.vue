...
<template>
  ...
  <div class="da relative overflow-hidden">
    ...
    >
      <div
        class="z-10 w-full h-40vw w-64vw sm:h-56 overflow-hidden rounded-xl border border-gray-200 opacity-80 transition duration-300 ease-in-out group-hover:opacity-100 dark:border-gray-700 dark:opacity-70"
      >
        <img
